    ...
    <Root>
      ...
      <InformationRoot>
        <UpperContainer>
          ...
          <CategoryContainer>
            ...
            <CategoryList>
              ...
              <Typo pointer>동물</Typo>
              <Typo pointer>다문화</Typo>
            </CategoryList>
          </CategoryContainer>
          <StayInTheLoopContainer>
            <Title bottom="15px">Stay In The Loop</Title>
            <Typo>
              동국대학교 블록체인 학회 2PLUSONE은 정기적인 모임을 통해
            </Typo>
        ...
        <LowerContainer>
          ...
          <Typo pointer>공지사항</Typo>
          <Typo pointer>이용약관</Typo>
          <Typo pointer>개인정보처리방침</Typo>
          <Typo pointer>고객지원</Typo>
          <SNSContainer>
            <FacebookImg pointer />
            <YoutubeImg pointer />
            <TwitterImg pointer />
